...
const add = async (req, res) => {
    try {
        handleCreate(req, res, medicalServicesModel, [], {}, "")
    } catch (error) {
...
const get = async (req, res) => {
    try {
        handleGet(req, res, medicalServicesModel, {})
    } catch (error) {
        return sendError(res, 404, error.message)
    }
}
...
const deleteData = async (req, res) => {
    try {
        handleDelete(req, res, medicalServicesModel, { _id: req.params.itemId })
    } catch (error) {
        return sendError(res, 404, error.message)
    }
}
...
const updateDate = async (req, res) => {
    try {
        ...
        handleUpdate(req, res, medicalServicesModel, [], {}, "", {
