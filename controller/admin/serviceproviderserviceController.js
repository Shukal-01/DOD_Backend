...
const add = async (req, res) => {
  try {
    handleCreate(req, res, serviceProviderServicesModel, [], {}, "");
  } catch (error) {
...
const get = async (req, res) => {
  try {
    handleGet(req, res, serviceProviderServicesModel, {});
  } catch (error) {
    return sendError(res, 404, error.message);
  }
};
...
const deleteData = async (req, res) => {
  try {
    handleDelete(req, res, serviceProviderServicesModel, {
...
const updateDate = async (req, res) => {
  try {
    handleUpdate(req, res, serviceProviderServicesModel, [], {}, "", {
      _id: req.params.itemId,
    });
  } catch (error) {
    return sendError(res, 404, error.message);
