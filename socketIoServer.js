...
function startLocalSocketServer() {
  ...
  server.listen(process.env.SOCKEIOTPORT, "0.0.0.0", () => {
    console.log(`Socket Io Server running on port ${process.env.SOCKEIOTPORT}`);
  });
}

module.exports = startLocalSocketServer;
